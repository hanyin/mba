...
/**
 * Created by 韩银 on 2017/11/7 10:47
 * hanyinit@163.com
 */

public class AcceptMsgListener implements PacketListener {
    ...
    public AcceptMsgListener(MsfService context, NotificationManager mNotificationManager){
    ...
    public void processPacket(Packet packet) {
        ...
        try {
            ...
            String to=msgs[0];//接收者
            String from=msgs[1];//发送者
