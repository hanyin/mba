...
import com.hy.mvp.R;
import com.hy.mvp.utils.UIUtils;

/**
 * Created by 韩银 on 2017/10/9 15:50
 * hanyinit@163.com
 */
...
public abstract class BaseNiceDialog extends DialogFragment {
    ...
    public abstract void convertView(BaseViewHolder holder, BaseNiceDialog dialog);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        convertView(BaseViewHolder.create(view), this);
        return view;
    }
    ...
    private void initParams() {
        ...
        if (window != null) {
            ...
            //设置dialog宽度
            if (width == 0) {
                lp.width = UIUtils.getScreenWidth(getContext()) - 2 * UIUtils.dp2px(getContext(), margin);
            } else if (width == -1) {
                lp.width = WindowManager.LayoutParams.WRAP_CONTENT;
            } else {
                lp.width = UIUtils.dp2px(getContext(), width);
            }
            ...
            if (height == 0) {
                ...
                lp.height = UIUtils.dp2px(getContext(), height);
            }
